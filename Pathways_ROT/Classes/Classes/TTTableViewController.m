...
- (UITableView*)tableView {
  if (!_tableView) {
      ...
      if (self.navigationController.navigationBar.barStyle == UIBarStyleBlackTranslucent) {
          _tableView = [[TTTableView alloc] initWithFrame:CGRectOffset(self.view.bounds, 0, 44) style:_tableViewStyle];
      } else {
          _tableView = [[TTTableView alloc] initWithFrame:CGRectOffset(self.view.bounds, 0, 0) style:_tableViewStyle];
      }
