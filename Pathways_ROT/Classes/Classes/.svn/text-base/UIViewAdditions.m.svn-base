...
- (void)presentAsKeyboardAnimationDidStop {
	...
	CGRect centerBegin = CGRectMake(0, 0, floor(screenFrame.size.width/2 - self.width/2),
                                    screenFrame.size.height - floor(self.height/2));
	CGRect centerEnd = CGRectMake(0, 0, floor(screenFrame.size.width/2 - self.width/2),
                                  screenFrame.size.height + floor(self.height/2));
	
	NSDictionary* userInfo = [NSDictionary dictionaryWithObjectsAndKeys:
							  [NSValue valueWithCGRect:bounds], UIKeyboardFrameBeginUserInfoKey,
							  [NSValue valueWithCGRect:centerBegin], UIKeyboardFrameBeginUserInfoKey,
							  [NSValue valueWithCGRect:centerEnd], UIKeyboardFrameEndUserInfoKey,
							  nil];
